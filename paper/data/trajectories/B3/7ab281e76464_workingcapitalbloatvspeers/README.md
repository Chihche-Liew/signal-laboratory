# B3 · WorkingCapitalBloatVsPeers

- Signal ID: `7ab281e76464`
- Pair / generation: `accrual_quality` / `gen_002`
- Origin stage: critic-triggered revision (raw_responses.jsonl row 3)
- Original experiment: `paper/data/formal/baseline_r3/2026-08-06T00-53-27_baseline_accrual_quality`
