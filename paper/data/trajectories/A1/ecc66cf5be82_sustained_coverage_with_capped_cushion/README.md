# A1 · Sustained Coverage With Capped Cushion

- Signal ID: `ecc66cf5be82`
- Pair / generation: `profit_distress` / `gen_009`
- Origin stage: single-agent proposal (raw_responses.jsonl row 1)
- Original experiment: `paper/data/formal/ablation_no_critique/2026-08-03T22-42-21_ablation_no_critique_profit_distress`
